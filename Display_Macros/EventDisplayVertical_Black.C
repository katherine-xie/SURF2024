...
std::string fullPath = "/Users/katherinexie/SURF2024/futureCollidersData/mupmum_3000GeV.root";
int currentEvtIndx;
float currentPtCut; // Represents pT cutoff


void EventDisplayVertical_Black(int eventIndx = 555, 
		                                  float ptCut = 0, 
		                                  bool doWTA = false,
		                                  bool verbose = 0) {
